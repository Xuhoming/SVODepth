...
macro(find_boost)
  ...
  find_package(Boost 1.40.0 ${QUIET_} COMPONENTS system filesystem thread date_time iostreams serialization)
...
macro(find_dssdk)
  ...
  if(NOT DSSDK_DIR AND ("TRUE" STREQUAL "TRUE"))
    get_filename_component(DSSDK_DIR_HINT "/opt/softkinetic/DepthSenseSDK/include" PATH)
  endif()
...
macro(find_VTK)
  if(PCL_ALL_IN_ONE_INSTALLER AND NOT ANDROID)
    if(EXISTS "${PCL_ROOT}/3rdParty/VTK/lib/cmake")
      set(VTK_DIR "${PCL_ROOT}/3rdParty/VTK/lib/cmake/vtk-5.8")
    else()
...
elseif(EXISTS "${PCL_DIR}/include/pcl/pcl_config.h")
  ...
  set(PCL_SOURCES_TREE "/home/cwu/Experiment/SVO/workspace/pcl")
...
set(pcl_all_components  common kdtree octree search sample_consensus filters io 2d features keypoints ml registration recognition stereo surface geometry segmentation visualization tracking outofcore people )
